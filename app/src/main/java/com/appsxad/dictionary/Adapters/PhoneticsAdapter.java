...
import com.appsxad.dictionary.Models.Phonetics;
import com.appsxad.dictionary.R;
import com.appsxad.dictionary.ViewHolders.PhoneticViewHolder;
...
public class PhoneticsAdapter extends RecyclerView.Adapter<PhoneticViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PhoneticViewHolder holder, int position) {
        ...
        holder.imageButon_audio.setOnClickListener(new View.OnClickListener() {
            @Override
