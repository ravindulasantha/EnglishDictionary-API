package com.appsxad.dictionary.Adapters;
...
import com.appsxad.dictionary.Models.Meanings;
import com.appsxad.dictionary.R;
import com.appsxad.dictionary.ViewHolders.MeaningsViewHolder;

import java.util.List;

public class MeaningAdpater extends RecyclerView.Adapter<MeaningsViewHolder> {
    private Context context;
    protected List<Meanings> meaningsList;

    public MeaningAdpater(Context context, List<Meanings> meaningsList) {
    ...
    public void onBindViewHolder(@NonNull MeaningsViewHolder holder, int position) {
        holder.textVew_partOfSpeech.setText("Parts of Speech: "+meaningsList.get(position).getPartOfSpeech());
